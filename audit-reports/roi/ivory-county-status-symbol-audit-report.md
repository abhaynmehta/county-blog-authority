...
**File:** blogs/roi-incoming/ivory-county-status-symbol.md
**Score:** 70/100
**Publishable:** No
**Word Count:** 306
**Paragraphs:** 12
...
### CG-CONTENT-002: RERA mentioned but no registration number provided
...
### CG-CONTENT-005: Thin content: only 306 words (minimum 800 for ranking potential)
...
- **Owner:** ROI
- **Category:** meta_title
- **Found:** "Ivory County Sector 115 Noida - Premium Luxury Apartments | Blog"
