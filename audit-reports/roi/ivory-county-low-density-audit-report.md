...
**File:** blogs/roi-incoming/ivory-county-low-density.md
**Score:** 52/100
**Publishable:** No
**Word Count:** 421
**Paragraphs:** 18
...
- **Paragraph:** 18
- **Found:** "Meta Title: How Ivory County is setting standards as the Best Low-Density Residential Project in Noida | Blog
Meta Description: Experience low-density luxury living at Ivory County, Noida. Spacious 3,"
...
### CG-CONTENT-004: Area figures (1 mentions) not labeled as carpet area
...
### CG-CONTENT-007: Thin content: only 421 words (minimum 800 for ranking potential)
...
### CG-META-001: Meta title too long (97 chars, may truncate)

- **Owner:** ROI
- **Category:** meta_title
- **Found:** "How Ivory County is setting standards as the Best Low-Density Residential Project in Noida | Blog"
- **Action:** Shorten title to 60 characters or fewer
- **Acceptance test:** Title is 30-60 characters

### CG-META-002: Meta description too long (176 chars)

- **Owner:** ROI
- **Category:** meta_description
- **Found:** "Experience low-density luxury living at Ivory County, Noida. Spacious 3, 4, and 5 BHK apartments with premium amenities, open green spaces, and unmatched privacy in Sector 115."
