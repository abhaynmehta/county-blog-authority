...
|---|----------|-------|--------|-----------------|
| CG-META-001 | MEDIUM | Meta title too long (82 chars, may truncate) | Shorten title to 60 characters or fewer | Title is 30-60 characters |
| CG-META-002 | MEDIUM | Meta description too long (199 chars) | Shorten to 120-160 characters | Description is 120-160 characters |
| CG-CONTENT-003 | HIGH | Travel time claim needs verification — never state as guaranteed | Add verified source or remove claim | Claim has inline source attribution |
| CG-CONTENT-004 | CRITICAL | Prohibited language: 'unmatched claim' | Remove or rephrase the 'unmatched claim' claim | No 'unmatched claim' language remains |
